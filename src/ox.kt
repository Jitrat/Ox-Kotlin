...
fun inputRC(boardXO: Array<Array<Char>>): Array<Int> {
    while (true) {
        try {
            ...
            if(inputarr?.size != 2) {
                println("Error must enter 2 number!! Please enter a new.")
                continue
            }
            ...
            if(row > 3 || row < 1 || col >3 || col < 1) {
                println("Error must enter number in 1..3!! Please enter a new.")
                continue
            }
            ...
            println("Error must be number!! Please enter a new.")
        }
...
fun checkWin(boardXO: Array<Array<Char>>, player: Char): Boolean {
    ...
    // \ win
    if (boardXO[1][1] == player && boardXO[2][2] == player && boardXO[3][3] == player) {
        win = true
    }
    // / win
    if (boardXO[1][3] == player && boardXO[2][2] == player && boardXO[3][1] == player) {
        win = true
    }
    return win
}